// original code from: https://lassieadventurestudio.wordpress.com/2008/10/07/image-outline/
// i dont understand anything of ths :)
...
class ImageWithOutline
{
	...
	public static function renderImage(src:IBitmapDrawable, weight:Int, color:UInt, alpha:Float = 1, antialias:Bool = false, threshold:Int = 150):Bitmap
	{
		...
		return new Bitmap(ImageWithOutline.outline(render, weight, color, alpha, antialias, threshold));
	}
